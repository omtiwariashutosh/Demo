...
var getColor = function getColor(name) {
  ...
  return getComputedStyle(dom)
    .getPropertyValue("--sparrow-".concat(name))
    .trim();
};
...
var bgPlayerInit = function bgPlayerInit() {
  ...
  var youtubeEmbedElements = document.querySelectorAll(
...
var bigPictureInit = function bigPictureInit() {
  if (window.BigPicture) {
    ...
    bpItems.forEach(function (bpItem) {
      ...
      if (
        userOptions.imgSrc &&
        !bpItem.classList.value.split(" ").filter(function (className) {
    ...
    zforms.forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        window.Email.send({
          ...
          Body: "\n            <p>"
            .concat(formData.name, "</p>\n            <p>")
            .concat(formData.message, "</p>\n          "),
        })
...
var isotopeInit = function isotopeInit() {
  if (window.Isotope) {
    ...
    masonryItems.length &&
      masonryItems.forEach(function (masonryItem) {
        window.imagesLoaded(masonryItem, function () {
          ...
          filterElement === null || filterElement === void 0
            ? void 0
...
var navbarInit = function navbarInit() {
  ...
  var closeBtnsList = Array.from(
    document.querySelectorAll(Selector.SIDEBAR_CLOSE)
  );
  var baseContentElList = Array.from(
    document.querySelectorAll(Selector.BASE_CONTENT)
  );
...
var preloaderInit = function preloaderInit() {
  ...
  window.imagesLoaded(bodyElement, function () {
    ...
    preloader === null || preloader === void 0
      ? void 0
